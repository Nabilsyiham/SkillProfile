...
class _$AddressImpl implements _Address {
  ...
  @override
  String toString() {
    return 'Address(id: $id, userId: $userId, label: $label, recipientName: $recipientName, phone: $phone, address: $address, city: $city, province: $province, postalCode: $postalCode, latitude: $latitude, longitude: $longitude, isDefault: $isDefault)';
  }
